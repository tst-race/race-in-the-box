...
import { NodeClassTemplates } from '../components/NodeClassTemplates';
...
export const NodeClassTemplatesPage = () => (
  <Page breadcrumbs={BREADCRUMBS} title="Node Class Templates">
    <ActionButtons>
