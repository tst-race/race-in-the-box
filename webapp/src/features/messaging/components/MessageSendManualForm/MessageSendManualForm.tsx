...
import { useSendManualMessages } from '../../api/messageSendManual';
import { SendManualRequest } from '../../types';
type Inputs = SendManualRequest;
...
export type MessageSendManualFormProps = {
  mode: DeploymentMode;
  name: string;
};

export const MessageSendManualForm = ({ mode, name }: MessageSendManualFormProps) => {
  const send = useSendManualMessages();
