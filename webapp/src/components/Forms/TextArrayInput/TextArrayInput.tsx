...
import { TextArrayEntryInput } from './TextArrayEntryInput';
...
type TextArrayInputProps<Inputs> = {
  onAppend: (entry: TextArrayEntry) => void;
...
export const TextArrayInput = <Inputs,>({
  errors,
  fields,
  label,
  name,
