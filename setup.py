...
def main() -> None:
    ...
    setup(
        ...
        description=(
            "RACE in the Box allows for develpment and deployment of the RACE tool"
        ),
        ...
        name="race-in-the-box",
        packages=packages,
        project_urls={},
        python_requires=">3.6",
        scripts=["./rib/bin/rib", "./rib/bin/rib-use"],
        setup_requires=setup_requirements,
        tests_require=test_requirements,
        url="https://github.com/tst-race/race-in-the-box",
        version=version,
    )
